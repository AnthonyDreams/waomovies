...
$(function(){
	...
	var deleteac = $(".deleteac");
	var signupLink = $(".signupLink");
	var loginct = $( "#login-content" );
	var loginctt = $( "#delete-content" );
	...
	// pop up for delete accout 
	deleteac.on('click', function(event){
		event.preventDefault();
		loginctt.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
				$(target).find(loginctt).each( function(){
					$(this).removeClass("openform");
				});
				setTimeout( function(){
					$(target).removeClass("openform");
